 ...
 */
public class CellHoriWallAi extends GameObject {
	 ...
	 * @param id id of wall
	 */
	public CellHoriWallAi(int x, int y, ID id) {
		super(x,y,id);
	}
	...
	public Rectangle2D getBounds() {
		return new Rectangle2D(x,y,GameAi.cellSize,5);
	}
	...
	public void render(GraphicsContext g) {
		...
		g.fillRect(x, y, GameAi.cellSize,5);
	}
